...
## USE
- Connection your Organiser II device via a COMMS link to the computers serial port with default settings (9600, N, 8, 1, XON, NONE) 
- Start the emulator, use its connect feature to connect WebSerial to the COMMS port of the host computer
- Run your code, list or other utility

If needing to support graphic printing ensure the helper stub code GPRINT: is downloaded into A: first and translated ready for use.
Remove GPRINT if using the Printer II.
