...
return `
        <div class="tabs-container">
            ...
            <div class="tab-content active" id="tab-general">
                ...
                <div style="margin-bottom: 10px;"><label style="cursor: pointer;"><input type="radio" name="opt-target" value="Standard" style="margin-right: 8px;"><b>Standard (CM / XP / LA)</b><br><span style="font-size: 11px; margin-left: 25px; opacity: 0.8;">Compatible with all Organiser II models (LZ series use simulated 2 line mode)</span></label></div>
