...
this.myelement.style.overflowY="auto";
...
this.colors={
byte0:{stroke:'#4caf50',bg:'rgba(76, 175, 80, 0.1)',border:'#4caf50'},
byte1:{stroke:'#2196f3',bg:'rgba(33, 150, 243, 0.1)',border:'#2196f3'},
byteTime:{stroke:'#9c27b0',bg:'rgba(156, 39, 176, 0.1)',border:'#9c27b0'},
byteCk:{stroke:'#ff9800',bg:'rgba(255, 152, 0, 0.1)',border:'#ff9800'},
byteCnt:{stroke:'#00bcd4',bg:'rgba(0, 188, 212, 0.1)',border:'#00bcd4'}
};


var hexCol=document.createElement('fieldset');
...
legend.style.color='var(--text-color-secondary, #aaa)';
...
val.style.color='var(--text-color, #e0e0e0)';
...
formCol.style.gap='20px';
formCol.style.flex='1';
formCol.style.maxWidth='400px';
...
this.myelement.appendChild(contentWrapper);
this.svgWrapper=contentWrapper;
...
return {
x:isRightSide?(r.left-rect.left):(r.right-rect.left),
...
svgHTML+=`<circle cx="${x2}" cy="${y2}" r="3" fill="${c.color}" />`;
}
});
