...
FileEditor.call(this,editorelement,callback,[4]);
}
...
".comms-group { display: grid; grid-template-columns: 1fr 1fr; column-gap: 20%; row-gap: 5px; padding: 0; }" +
...
".comms-header-row { margin-bottom: 10px; padding-bottom: 10px; display: flex; align-items: center; gap: 20px; border-bottom: 1px solid var(--border-color); }" +
...
"<div class='comms-group' style='column-gap: 10%;'>" +
"  <div>" +
