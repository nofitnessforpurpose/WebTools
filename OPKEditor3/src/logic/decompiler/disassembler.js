...
add(0x60,'NEG','IND');
add(0x61,'AIM','IMM_IND');
add(0x62,'OIM','IMM_IND');
add(0x63,'COM','IND');
add(0x64,'LSR','IND');
add(0x65,'EIM','IMM_IND');
add(0x66,'ROR','IND');
add(0x67,'ASR','IND');
add(0x68,'ASL','IND');
add(0x69,'ROL','IND');
add(0x6A,'DEC','IND');
add(0x6B,'TIM','IMM_IND');
add(0x6C,'INC','IND');
add(0x6D,'TST','IND');
add(0x6E,'JMP','IND');
add(0x6F,'JSR','IND');
...
add(0x70,'NEG','EXT');
add(0x71,'AIM','IMM_DIR');
add(0x72,'OIM','IMM_DIR');
add(0x73,'COM','EXT');
