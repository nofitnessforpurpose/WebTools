...
else if(arg==='S')size+=1+codeBlock[pc+size];
...
if(size===1)size=codeBlock.length-pc;
...
const logName=String.fromCharCode(65+args.logicalFile);
...
const logicalFile=String.fromCharCode(65+args.logicalFile);
